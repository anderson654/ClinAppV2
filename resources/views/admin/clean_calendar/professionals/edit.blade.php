...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.professionals.update', $user->id]]) !!}
        ...
        <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
					...
					{!! Form::select('state', $states, old('state'), ['class' => 'form-control', 'placeholder' => '']) !!}
					 @isset($client->address->city->title)	  
					  {!! Form::text('state', $client->address->city->state_id, ['class' => 'form-control hidden', 'placeholder' => '']) !!}</td>
					 @endisset
			...
			<div class="row">
                <div class="col-xs-12 form-group">
					...
					@isset($client->address->city->title)	  
					  <td>{!! Form::label('city', $client->city->city, ['class' => 'form-control', 'placeholder' => '']) !!}
