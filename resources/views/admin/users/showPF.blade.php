...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <div class="row">
                <div class="col-md-4">
                    <table class="table table-hover">
                        <tr>
                            ...
                            <td field-key='name'>{{ $user->client->name or '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td field-key='birthdate'>{{ $user->client->birthdate or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.users.fields.gender')</th>
                            <td field-key='gender'>{{ $user->client->gender or '' }}</td>
                        </tr>
                        @php
                            $count = 0;
                        @endphp
                                                    ...
                                                    <div class="container" style="width: 100%">
                                                        <div class="fluid-row">
                                                            <ul>
                                                                ...
                                                                <li><strong>CEP:
                                                                    </strong>{{ $address->zip ? $address->zip : 'vazio' }}
                                                                </li>
                                                                <li><strong>Complemento</strong>{{ $address->complement }}
                                                                </li>
                                                                <li><strong>Bairro: </strong>{{ $address->neighborhood }}
                                                                </li>
                                                                <li><strong>Cidade:
                ...
                @endif
                <div class="col-md-6" id="logModal">
    ...
    'route' => ['admin.services.destroy', $service->id],
                                            ...
                                            {!! Form::submit(trans('abrigosoftware.as_delete'), [
    'class' => 'btn btn-xs
                                                btn-danger',
]) !!}
                                            {!! Form::close() !!}
