            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        {!! Form::label('name', 'Razão Social' . '*', ['class' => 'control-label']) !!}
                        {!! Form::text('name', $clientPJ->name, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::text('nome_fantasia', $clientPJ->nome_fantasia, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        {!! Form::label('inscricao_estadual', 'Inscrição Estadual', ['class' => 'control-label']) !!}
                        {!! Form::text('inscricao_estadual', $clientPJ->inscricao_estadual, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                    ...
                    <div class="col-md-6 form-group">
                        {!! Form::label('incricao_municipal', 'Incrição Municipal', ['class' => 'control-label']) !!}
                        {!! Form::text('incricao_municipal', $clientPJ->inscricao_municipal, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                        @if ($errors->has('incricao_municipal'))
                            <p class="help-block">
                                {{ $errors->first('incricao_municipal') }}
                            </p>
                        @endif
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::text('cnpj', $clientPJ->cnpj, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        <p class="help-block"></p>
                        @if ($errors->has('cnpj'))
                            <p class="help-block">
                                {{ $errors->first('cnpj') }}
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        {!! Form::text('email', old('email'), ['class' => 'form-control', 'placeholder' => '', 'colw' => '10', 'rows' => '5']) !!}
                        <p class="help-block"></p>
                        @if ($errors->has('email'))
                            <p class="help-block">
                                {{ $errors->first('email') }}
                                            ...
                                            <div class="fluid-row">
                                                <form method="POST">
                                                    ...
                                                    <input type="text" name="complement" id="complement"
                                                        class="form-control" value="{{ $address->complement }}">
                                                    <label for="neighborhood">Bairro</label>
                                                    <input type="text" name="neighborhood" id="neighborhood"
                                                        class="form-control" value="{{ $address->neighborhood }}">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('admin.newClientAddress') }}" id="newAddressForm"
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="zip" id="naZip" class="form-control zip" onkeyup="getAddressCep(this)"
                        ...
                        <input type="text" name="neighborhood" id="naNeighborhood" class="form-control" required readonly>
