							...
							<div class="col-md-12 form-group">
								...
								<div class="col-md-5">
									<div class="input-group">
										...
										{!! Form::text('day_end', old('release_day_end'), ['class' => 'form-control date-end', 'placeholder' => 'Até']) !!}
									</div>
									<p class="help-block"></p>
								</div>							
							</div></br>
...
@section('javascript') 
    ...
    <script>
        ...
        $(document).ready(function () {
            window.dtDefaultOptions.ajax = '{!! route('admin.old.lead') !!}?day_start={{ request('day_start') }}&day_end={{ request('day_end') }}&city_id={{ request('city') }}';
