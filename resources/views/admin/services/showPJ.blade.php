                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='client'>{{ $service->corporateClient->razao_social or '' }}</td>
                        </tr>
						@can('admin_service_edit')
							<tr>
								<th>@lang('abrigosoftware.services.fields.email')</th>
								<td field-key='client'>{{ $service->user->email or '' }}</td>
							</tr>
						@endcan
                        <tr>
				...
				<div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='name'>{{ $service->corporateClient->razao_social or 'vazio'}}</td>
                        </tr>
                       @can('admin_service_edit')
							<tr>
