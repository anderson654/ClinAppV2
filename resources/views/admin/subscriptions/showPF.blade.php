...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='client'> <a target="_blank"
                                    href="{{ route('admin.users.show', $subscription->client_id) }} ">{{ $subscription->client->name or '' }}</a>
                            </td>

                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.subscriptions.fields.email')</th>
                            <td field-key='client'>{{ $subscription->client->email or '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td field-key='total_time'>{{ $subscription->value_service or '' }}</td>
                        </tr>
                        <tr>
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='gender'>{{ $subscription->client->gender or '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td field-key='street'>{{ $address->street or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.clients.fields.number')</th>
                            <td field-key='number'>{{ $address->number or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.clients.fields.zip')</th>
                            <td field-key='zip'>{{ $address->zip or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.clients.fields.neighborhood')</th>
                            <td field-key='neighborhood'>{{ $address->neighborhood or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.clients.fields.complement')</th>
                            <td field-key='complement'>{{ $address->complement or '' }}</td>
                        </tr>
                        <tr>
                            <th>@lang('abrigosoftware.clients.fields.city')</th>
                            <td field-key='city'>{{ $subscription->address->city->city or '' }}</td>
                        </tr>
                        <tr>
            ...
            @foreach ($subscription->subscriptionDayWeeks as $subscriptionDayWeek)
                <form method="GET"
                    action="{{ route('admin.subscriptions.storeDayWeekPP', $subscriptionDayWeek->dayWeek) }}">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body table-responsive no-padding">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td field-key='text'>
                                                    @if ($subscriptionDayWeek->dayWeek == 0)
                                                        Domingo
                                                    @elseif($subscriptionDayWeek->dayWeek == 1)
                                                        Segunda
                                                    @elseif($subscriptionDayWeek->dayWeek == 2)
                                                        Terça
                                                    @elseif($subscriptionDayWeek->dayWeek == 3)
                                                        Quarta
                                                    @elseif($subscriptionDayWeek->dayWeek == 4)
                                                        Quinta
                                                    @elseif($subscriptionDayWeek->dayWeek == 5)
                                                        Sexta
                                                    @elseif($subscriptionDayWeek->dayWeek == 6)
                                                        Sabado
                                                    @endif
                                                </td>
                                                <td field-key='text'>
                                                    ...
                                                    @if ($subscriptionDayWeek->preferred_professional)
                                                        ...
                                                        <a href="{{ route('admin.subscriptions.cancelPP', $subscriptionDayWeek->preferred_professional->id) }}"
    ...
    @endforeach
    <br><br>
    <form method="GET" action="{{ route('admin.subscriptions.storePP', $subscriptionDayWeek->dayWeek) }}">
                                ...
                                @foreach ($preferred_professional_WithOut_DayWeek as $preferred_professional)
                                    <tr>
                                        ...
                                        <td field-key='text'>
                                            ...
                                            <a href="{{ route('admin.subscriptions.cancelPP', $preferred_professional->id) }}"
                                                class="btn btn-xs btn-danger">Cancelar</a>
                                        </td>
                                    </tr>
                                @endforeach
