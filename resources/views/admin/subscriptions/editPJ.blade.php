        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    {!! Form::label('name', $subscription->user->name,  ['class' => 'form-control', 'placeholder' => '']) !!}
                  <p class="help-block"></p>
                            ...
                            @foreach ($addresses as $index => $address)
                                <li class="list-group-item">
                                    <div class="row toggle" id="dropdown-detail-1" data-toggle="detail-{{ $index }}">
                                        <div class="col-md-4">
                                            <input type="radio" name="client_address_id" value="{{ $address->id }}" @if ($subscription->client_address_id == $address->id) checked @endif> Endereço {{ $index + 1 }}
                                        </div>
