...
@section('content')
    ...
    {!! Form::model($service_type, ['method' => 'PUT', 'route' => ['admin.service_types.update', $service_type->id]]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('external_id', trans('abrigosoftware.service-type.fields.external-id').'', ['class' => 'control-label']) !!}
