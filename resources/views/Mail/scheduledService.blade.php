...
<body style="background: #fff">
    <div class="container">
        ...
        <div style="padding: 20px;margin-bottom: 30px" class="text-color-blue">
            ...
            <p class="fw-bold">Olá,{$name}
            </p>
            <p>Este E-mail é para informar que seu agendamento de serviço com a Clin App foi realizado com sucesso: </p>
            <p><span class="fw-bold text-color-blue"></span>{$serviceType}</p>
            <p><span class="fw-bold text-color-blue"></span>{$serviceCategory}</p>
            <p><span class="fw-bold text-color-blue"></span>$additionals</p>
            <p><span class="fw-bold text-color-blue">Data:</span>{$startTime} ás {$time} horas</p>
            <p><span class="fw-bold text-color-blue"></span>{$description}</p>
        </div>
        <div style="padding: 20px">
            <table style="width: 100vw"> <!-- Adicione uma borda para visualização, pode remover isso em produção -->
                <thead>
                    <tr>
            ...
            <p>Caso ainda tenha dúvidas adicionais, não hesite em nos contatar pelos seguintes meio:</p>
